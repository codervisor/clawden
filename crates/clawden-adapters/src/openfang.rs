...
pub struct OpenFangMeta;

impl RuntimeMeta for OpenFangMeta {
    const RUNTIME: ClawRuntime = ClawRuntime::OpenFang;
    const NAME: &'static str = "OpenFang";
...
pub type OpenFangAdapter = DockerAdapter<OpenFangMeta>;
...
mod tests {
    ...
    fn start_persists_forwarded_runtime_config() {
        ...
        runtime.block_on(async {
            let adapter = OpenFangAdapter::default();
            let handle = adapter
                .start(&AgentConfig {
